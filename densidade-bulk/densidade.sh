...
echo '############################################################'
echo 'sh densidade.sh n_at n_amostras. Ex: sh densidade.sh 17857 5'
echo '############################################################'

linhas=$1 #17857	#quantas linhas tem uma configuracao
amostras=$2 #5			#quantas configuracoes queremos amostrar
