...
**
       ...
       REAL         boxx,boxy,boxz,xx,zz,yy
       CHARACTER    text
******
1000  format(i5,i2,3f8.3)
1001  format(3f10.5)
1002  format(a44)
1003  format(i5)
       CALL READING
...
*
       ...
       REAL  incr
******
       OPEN (10, FILE='diff1.out', STATUS='UNKNOWN')
